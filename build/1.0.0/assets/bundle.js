...
/******/ 	var hotCurrentHash = "21df878d55d7aa52f110"; // eslint-disable-line no-unused-vars
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2), __webpack_require__(6), __webpack_require__(43).setImmediate))
...
var store = new _vuex2.default.Store({
    ...
    mutations: {
        upSing: function upSing(state, config) {
            ...
            if ((typeof config === 'undefined' ? 'undefined' : _typeof(config)) == 'object') return state.isSign = config.is;
            state.isSign = config;
        }
    }
});
...
var router = new _vueRouter2.default({
    routes: [{ path: '/', name: 'home', component: function component(resolve) {
        ...
        } }, { path: '/usercenter', name: 'usercenter', component: function component(resolve) {
